...
<html>
    ...
    <body class="skin-blue">
                                ...
                                <li>
                                    ...
                                    <ul class="menu">
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="pull-left">
                                                    <img src="${resourcePath}/img/avatar2.png" class="img-circle" alt="user image"/>
                                                </div>
                                                <h4>
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="pull-left">
                                                    <img src="${resourcePath}/img/avatar.png" class="img-circle" alt="user image"/>
                                                </div>
                                                <h4>
                                                    Developers
                        ...
                        <section class="col-lg-7 connectedSortable">
                            ...
                            <div class="box box-success">
                                ...
                                <div class="box-body chat" id="chat-box">
                                    <!-- chat item -->
                                    <div class="item">
                                        <img src="${resourcePath}/img/avatar.png" alt="user image" class="online"/>
                                        <p class="message">
                                            <a href="#" class="name">
                                    ...
                                    <!-- chat item -->
                                    <div class="item">
                                        <img src="${resourcePath}/img/avatar2.png" alt="user image" class="offline"/>
                                        <p class="message">
                                            <a href="#" class="name">
                                    ...
                                    <!-- chat item -->
                                    <div class="item">
                                        <img src="${resourcePath}/img/avatar3.png" alt="user image" class="offline"/>
                                        <p class="message">
                                            <a href="#" class="name">
        ...
        <script src="${resourcePath}/js/dashboard.js" type="text/javascript"></script>

        <!-- AdminLTE for demo purposes -->
        <script src="${resourcePath}/js/demo.js" type="text/javascript"></script>
    </body>
</html>